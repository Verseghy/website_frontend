...
import {
  Competition,
  CompetitionAboutView,
  CompetitionCardView,
  CompetitionFAQ,
  CompetitionHeroView,
  CompetitionHeroViewData,
  CompetitionRegistration,
  CompetitionRulesView,
  ...
  competitions: [
    {
      ...
      card: {
        shortDescription:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque a sapien eget elit suscipit pulvinar nec nec ante. Integer eleifend lacinia enim blandit rhoncus. Vivamus libero nibh, tristique eu pharetra in, tincidunt at neque.',
        ...
        rounds: [
          {
            ...
            description:
              'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque a sapien eget elit suscipit pulvinar nec nec ante. Integer eleifend lacinia enim blandit rhoncus.',
          },
          {
            name: 'Lorem Ipsum',
            start: Timestamp.now(),
